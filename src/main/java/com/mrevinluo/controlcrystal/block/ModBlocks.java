package com.mrevinluo.controlcrystal.block;
...
public class ModBlocks {
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(ControlCrystal.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(ControlCrystal.MOD_ID, name));
    }

    //初始化
    public static void RegCrystalOre() {}
}
